...
namespace tpfinal
{
	public class Backend
	{
		...
		{ 
//			tengo que pasarle parametros a conjuntoDeDatos? toma como parametros dos listas filas y encabezado....  en esta clase de casualidad tengo dos listas
//        	pregunta_usuario y respuesta_usuario seran esas?
			datasetEntrenamiento = new ConjuntoDeDatos();
			
//			se crea el arbol con dataset
